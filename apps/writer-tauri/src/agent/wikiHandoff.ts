 ...
 * content is filed as durable knowledge or skipped. */
const HANDOFF_PROMPT = `You are filing content the user picked from a chat into their wiki. The content is in the document below. Extract only durable, reusable knowledge — a specific non-obvious fact about an entity (a person, book, project, idea), or a concept / framework / method the user will look up later.
