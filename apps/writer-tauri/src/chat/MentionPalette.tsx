...
// open/close state, the filtered+ranked note list, and the selected index.
// Keyboard nav is intercepted in PromptInput so the textarea keeps focus and
// IME composition isn't disturbed.
